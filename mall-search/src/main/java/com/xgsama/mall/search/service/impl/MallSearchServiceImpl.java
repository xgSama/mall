...
import com.xgsama.mall.search.feign.ProductFeignService;
import com.xgsama.mall.search.service.MallSearchService;
import com.xgsama.mall.search.vo.AttrResponseVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    private SearchResult buildSearchResult(SearchResponse response, SearchParam Param) {
        ...
        for (Terms.Bucket bucket : attr_id.getBuckets()) {
            ...
            String attr_name = "";
            try {
                attr_name = ((ParsedStringTerms) bucket.getAggregations().get("attr_name_agg")).getBuckets().get(0).getKeyAsString();
            } catch (Exception e) {
